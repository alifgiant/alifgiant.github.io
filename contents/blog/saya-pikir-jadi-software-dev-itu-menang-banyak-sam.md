---
title: "Saya Pikir Jadi Software Dev Itu Menang Banyak, Sampai Saya Ngitung Pensiun PNS."
date: "2025-12-28"
tags: ["Rants"]
featured: false
...
## Jalur PNS di Kalimantan Selatan

Mari kita bedah angkanya secara detail. Jika saya jadi PNS di Pemprov Kalsel, pendapatan saya bukan cuma gaji pokok sesuai PP Nomor 5 Tahun 2024, tapi ada akumulasi TPP (Tambahan Penghasilan Pegawai) dan bonus tahunan.

### **Fase 1: Usia 21-30 (Masa Penyesuaian)**

Sebagai lulusan S1, saya masuk Golongan IIIa. Pendapatan bersih (Take Home Pay) awal sekitar Rp6 juta per bulan (Gaji Pokok + TPP). Dalam setahun ada 14 kali gaji (termasuk THR & Gaji-13). Ditambah sedikit honor kegiatan atau uang saku dinas (SPPD) sekitar Rp1 juta per bulan.

- Hitungan: (Rp6 juta x 14) + (Rp1 juta x 12) = Rp96 juta/tahun.
- **Akumulasi Usia 30:** 9 tahun x Rp96 juta = **Rp864 Juta.**

Coba kita lanjut hitung ke dekade berikutnya, karena di sinilah kenaikan pangkat mulai terasa pengaruhnya ke kantong.

### **Fase 2: Usia 31-40 (Level Menengah)**

Naik ke Golongan IIIc/IIId. Jabatan biasanya sudah fungsional ahli muda atau kasubag. THP naik jadi Rp9 juta/bulan ditambah bonus/SPPD yang juga naik ke Rp2 juta/bulan.

- Hitungan: (Rp9 juta x 14) + (Rp2 juta x 12) = Rp150 juta/tahun.
- **Akumulasi Usia 40:** Rp864 juta + (10 tahun x Rp150 juta) = **Rp2,36 Miliar.**

Setelah melewati masa menengah, kita lihat bagaimana perkembangannya saat masuk ke fase senior hingga menjelang pensiun.

### **Fase 3: Usia 41-50 (Level Senior)**

Masuk Golongan IVa/IVb sebagai ahli madya atau kabid. THP naik ke Rp12 juta/bulan dengan intensitas dinas/honor rapat yang lebih tinggi (Rp3,5 juta/bulan).

- Hitungan: (Rp12 juta x 14) + (Rp3,5 juta x 12) = Rp210 juta/tahun.
- **Akumulasi Usia 50:** Rp2,36 Miliar + (10 tahun x Rp210 juta) = **Rp4,46 Miliar.**

### **Fase 4: Usia 51-60 (Puncak Karier)**
...
## Jalur Karyawan BUMN Tier 1 **(Pertamina, Telkom, PLN)**
...
Pendapatan awal (Take Home Pay) rata-rata Rp10 juta per bulan dengan bonus tahunan (tantiem + THR) total 6 kali gaji.

- Hitungan: (Rp10 juta x 12) + (Rp10 juta x 6) = Rp180 juta/tahun.
- **Akumulasi Usia 30:** 9 tahun x Rp180 juta = **Rp1,62 Miliar.**

### **Fase 2: Usia 31-40 (Manager/Senior Manager)**

THP naik ke kisaran Rp25 juta per bulan dengan bonus tahunan yang lebih besar, sekitar 8 kali gaji karena performa manajerial.

- Hitungan: (Rp25 juta x 12) + (Rp25 juta x 8) = Rp500 juta/tahun.
- **Akumulasi Usia 40:** Rp1,62 Miliar + (10 tahun x Rp500 juta) = **Rp6,62 Miliar.**

### **Fase 3: Usia 41-50 (Vice President/General Manager)**

Di level ini pendapatan melompat ke Rp50 juta per bulan dengan bonus tahunan mencapai 10 kali gaji.

- Hitungan: (Rp50 juta x 12) + (Rp50 juta x 10) = Rp1,1 Miliar/tahun.
- **Akumulasi Usia 50:** Rp6,62 Miliar + (10 tahun x Rp1,1 Miliar) = **Rp17,62 Miliar.**

### **Fase 4: Usia 51-60 (Senior VP/Management)**
...
## Realitas di Balik Angka: Karier yang Tidak Selalu Mulus
...
Masalahnya, jalan yang saya ambil sekarang benar-benar berada di luar ekosistem tersebut. Saya adalah seorang **Software Developer**. Saya bekerja secara remote untuk perusahaan IT besar dan sesekali mengambil proyek freelance. Saya tidak punya "jaminan" kenaikan pangkat otomatis, tidak punya TPP daerah, apalagi kucuran tantiem tahunan yang masif.

Melihat angka-angka di atas jujur memunculkan rasa was-was. Jika jalur PNS dan BUMN terasa begitu terukur dan bisa diprediksi, dunia tech justru menawarkan sebaliknya: kecepatan yang penuh ketidakpastian. Di sini, pengetahuan saya bisa menjadi *obsolete* atau basi hanya dalam dua tahun. Teknologi terus terganti, AI mulai mengambil alih peran penulisan kode dasar, dan bayang-bayang PHK massal selalu mengintai jika ekonomi perusahaan goyang sedikit saja. Tidak ada jaminan keamanan "seumur hidup" di balik layar monitor ini.

Tapi, ada sisi lain yang menarik: di dunia IT, tidak semua engineer akan "mati" setelah usia produktif. Banyak *senior engineer* atau *architect* yang justru semakin dibayar mahal seiring bertambahnya pengalaman. Selama mereka tetap relevan dan mampu beradaptasi dengan stack baru, nilai mereka di pasar global tetap sangat tinggi.

### Mengapa Keresahan Ini Menarik Ditinjau?

Mungkin ada yang bertanya, buat apa sih pusing menghitung angka puluhan tahun ke depan? Bagi saya, ini bukan sekadar soal uang, tapi soal **Manajemen Risiko Hidup**.

Keresahan ini menarik karena kita sedang membandingkan dua filosofi hidup yang sangat kontras:

1. **PNS/BUMN:** Mengandalkan sistem dan institusi untuk menjamin masa tua. Kelebihannya adalah stabilitas, tapi risikonya adalah ketergantungan total pada kebijakan negara atau perusahaan. Jika sistem berubah, kita tidak punya banyak pilihan.
