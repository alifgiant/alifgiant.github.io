...
```
<figcaption class="notion-caption">View State with class inheritance</figcaption>
...
```
<figcaption class="notion-caption">Simple View State with fields</figcaption>
...
```
<figcaption class="notion-caption">Utils class to select view based on state</figcaption>
